...
public:
    ...
    void setupUi(QWidget *TalkWindowClass)
    {
        ...
        TalkWindowClass->setStyleSheet(QString::fromUtf8(""));
        verticalLayout = new QVBoxLayout(TalkWindowClass);
...
"}"));
    ...
    {
        TalkWindowClass->setWindowTitle(QApplication::translate("TalkWindowClass", "QQTalkWindow", nullptr));
    } // retranslateUi
